...
TWO=`cat appoptics/__init__.py | grep "^__version__" | ruby -ne 'puts $_.match(/([\d\.]+)\"/)[1]'`
...
mv _tmp setup.py
cat appoptics/__init__.py | ruby -ne 'puts $_.gsub(/__version__ = \"[\d\.]+\"/,  "__version__ = \"" + ENV["_NEW"] + "\"")'  > _tmp
mv _tmp appoptics/__init__.py
